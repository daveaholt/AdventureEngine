...
void OGraphicsEngine::drawTriangle(ui32 vertexCount, ui32 offset)
{
...
OVertexArrayObjectPtr OGraphicsEngine::createVertexArrayObejct(const OVertexBufferData& data)
{
